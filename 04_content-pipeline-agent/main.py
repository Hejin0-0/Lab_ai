...
class ContentPipelineFlow(Flow[ContentPipelineState]):
    ...
    def handle_make_blog(self):
        ...
        llm = LLM(model="openai/gpt-5-nano-2025-08-07", response_format=BlogPost)
    ...
    def handle_make_tweet(self):
        ...
        llm = LLM(model="openai/gpt-5-nano-2025-08-07", response_format=Tweet)
    ...
    def handle_make_linkedin_post(self):
        ...
        llm = LLM(model="openai/gpt-5-nano-2025-08-07", response_format=LinkedInPost)
