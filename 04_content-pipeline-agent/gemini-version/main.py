...
class ContentPipelineFlow(Flow[ContentPipelineState]):
    ...
    def handle_make_blog(self):
        ...
        try:
            ...
            if json_match:
                ...
                self.state.blog_post = BlogPost.model_validate_json(json_str)
    ...
    def handle_make_tweet(self):
        ...
        try:
            ...
            if json_match:
                json_str = json_match.group()
                self.state.tweet = Tweet.model_validate_json(json_str)
    ...
    def handle_make_linkedin_post(self):
        ...
        try:
            ...
            if json_match:
                json_str = json_match.group()
                self.state.linkedin_post = LinkedInPost.model_validate_json(json_str)
        ...
        result = (
            ...
            .kickoff(
                inputs={
                    ...
                    "content": (
                        self.state.tweet.model_dump_json()
                        if self.state.content_type == "tweet"  # contenty_type -> content_type 오타 수정
